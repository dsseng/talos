	...
	doc := &encoder.Doc{
		...
		Fields: []encoder.Doc{
			...
			},
			{
				...
				Type:        "Duration",
				Note:        "",
				Description: "The period at which the filesystems are scrubbed.\n\nDefault value is 1 week, minimum value is 10 seconds.",
				Comments:    [3]string{"" /* encoder.HeadComment */, "The period at which the filesystems are scrubbed." /* encoder.LineComment */, "" /* encoder.FootComment */},
			},
		},
	}
	...
	doc := &encoder.Doc{
		...
		Fields: []encoder.Doc{
			...
			},
			{
				...
				Type:        "Duration",
				Note:        "",
				Description: "The period at which the volume is scrubbed, overriding the global scrub period.",
				Comments:    [3]string{"" /* encoder.HeadComment */, "The period at which the volume is scrubbed, overriding the global scrub period." /* encoder.LineComment */, "" /* encoder.FootComment */},
			},
		},
	}
